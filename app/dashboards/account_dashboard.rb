...
class AccountDashboard < Administrate::BaseDashboard
  ...
  enterprise_attribute_types = if BchatApp.enterprise?
                                 {
  ...
  enterprise_show_page_attributes = BchatApp.enterprise? ? %i[limits all_features] : []
  ...
  enterprise_form_attributes = BchatApp.enterprise? ? %i[limits all_features] : []
  FORM_ATTRIBUTES = (%i[
    name
    locale
    status
