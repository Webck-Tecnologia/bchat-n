...
describe('nextAvailabilityTimeMixin', () => {
  ...
  beforeEach(() => {
    window.bchatWebChannel = bchatWebChannel;
  });

  afterEach(() => {
    delete window.bchatWebChannel;
  });
  ...
  it('should return channelConfig', () => {
    ...
    const vm = new Constructor().$mount();
    const wrapper = createWrapper(vm);
    expect(wrapper.vm.channelConfig).toEqual(bchatWebChannel);
  });
  ...
  it('should return workingHours', () => {
    ...
    const vm = new Constructor().$mount();
    const wrapper = createWrapper(vm);
    expect(wrapper.vm.workingHours).toEqual(bchatWebChannel.workingHours);
  });
  ...
  it('should return currentDayWorkingHours', () => {
    ...
    const expectedWorkingHours = bchatWebChannel.workingHours.find(
  ...
  it('should return hoursAndMinutesBackInOnline', () => {
    ...
    const currentDayCloseHour =
      bchatWebChannel.workingHours[wrapper.vm.currentDay].close_hour;
    const nextDayOpenHour =
      bchatWebChannel.workingHours[
  ...
  it('should return in 30 minutes', () => {
    ...
    bchatWebChannel.workingHours[4].open_hour = 18;
    bchatWebChannel.workingHours[4].open_minutes = 0;
    bchatWebChannel.workingHours[4].close_hour = 23;
  ...
  it('should return in 3 hours', () => {
    ...
    bchatWebChannel.workingHours[4].open_hour = 19;
  ...
  it('should return at 10:00 AM', () => {
    ...
    bchatWebChannel.workingHours[4].open_hour = 10;
  ...
  it('should return tomorrow', () => {
    ...
    bchatWebChannel.workingHours[4].open_hour = 9;
    bchatWebChannel.workingHours[4].close_hour = 16;
  ...
  it('should return on Saturday', () => {
    ...
    bchatWebChannel.workingHours[4].open_hour = 9;
    bchatWebChannel.workingHours[4].close_hour = 16;
    bchatWebChannel.workingHours[5].closed_all_day = true;
