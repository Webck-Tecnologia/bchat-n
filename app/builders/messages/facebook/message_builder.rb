# This class creates both outgoing messages from bchat and echo outgoing messages based on the flag `outgoing_echo`
# Assumptions
# 1. Incase of an outgoing message which is echo, source_id will NOT be nil,
#    based on this we are showing "not sent from bchat" message in frontend
...
class Messages::Facebook::MessageBuilder < Messages::Messenger::MessageBuilder
  ...
  def perform
    ...
    BchatExceptionTracker.new(e, account: @inbox.account).capture_exception
    true
  end
  ...
  def contact_params
    begin
      ...
      if e.message.include?('2018218')
        ...
        BchatExceptionTracker.new(e, account: @inbox.account).capture_exception unless @outgoing_echo
      end
    rescue StandardError => e
      result = {}
      BchatExceptionTracker.new(e, account: @inbox.account).capture_exception
