class Api::V1::AccountsController < Api::BaseController
  ...
  def show
    @latest_bchat_version = ::Redis::Alfred.get(::Redis::Alfred::LATEST_CHATWOOT_VERSION)
  ...
  def validate_captcha
    raise ActionController::InvalidAuthenticityToken, 'Invalid Captcha' unless BchatCaptcha.new(params[:h_captcha_client_response]).valid?
  end
