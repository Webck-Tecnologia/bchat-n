class Integrations::Csml::ProcessorService < Integrations::BotProcessorService
  ...
  def client_params(session_id)
    {
      bot_id: "bchat-bot-#{conversation.inbox.id}",
      channel_id: "bchat-bot-inbox-#{conversation.inbox.id}",
      user_id: session_id
    }
  end
  ...
  def bot_payload
    {
      id: "bchat-csml-bot-#{agent_bot.id}",
      name: "bchat-csml-bot-#{agent_bot.id}",
      default_flow: 'bchat_bot_flow',
      flows: [
        {
          id: "bchat-csml-bot-flow-#{agent_bot.id}-inbox-#{conversation.inbox.id}",
          name: 'bchat_bot_flow',
