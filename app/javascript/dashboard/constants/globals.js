export default {
  ...
  DOCS_URL: '//www.bchat.com/docs/product/',
  HELP_CENTER_DOCS_URL: '//www.bchat.com/docs/product/others/help-center',
  TESTIMONIAL_URL: 'https://testimonials.cdn.bchat.com/content.json',
