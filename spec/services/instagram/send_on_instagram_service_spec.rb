  ...
  describe '#perform' do
    context 'with reply' do
      ...
      context 'without message_tag HUMAN_AGENT' do
        ...
        it 'if message is sent from bchat and is outgoing' do
        ...
        it 'if message is sent from bchat and is outgoing with multiple attachments' do
        ...
        it 'if message with attachment is sent from bchat and is outgoing' do
        ...
        it 'if message sent from bchat is failed' do
          message = create(:message, message_type: 'outgoing', inbox: instagram_inbox, account: account, conversation: conversation)
