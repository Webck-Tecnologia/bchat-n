...
gem 'azure-storage-blob', git: 'https://github.com/chatwoot/azure-storage-ruby', branch: 'bchat', require: false
...
gem 'devise', '>= 4.9.4'
gem 'devise-secure_password', git: 'https://github.com/chatwoot/devise-secure_password', branch: 'bchat'
...
gem 'html2text', git: 'https://github.com/chatwoot/html2text_ruby', branch: 'bchat'
