...
<Meta title="Bchat/Introduction" />

# Welcome to Bchat styleguide
...
Anyone willing to contribute to Bchat is encouraged to read this style guide. This style guide is also open source. If you feel that there are rooms for improvement, feel free to raise an issue or a pull request to the repository.
