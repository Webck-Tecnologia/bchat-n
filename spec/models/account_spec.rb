...
RSpec.describe Account do
  ...
  describe 'usage_limits' do
    ...
    it 'returns BchatApp.max limits' do
      expect(account.usage_limits).to eq({ agents: BchatApp.max_limit, inboxes: BchatApp.max_limit })
    end
  end
  ...
  describe 'support_email' do
    ...
    it 'returns the support email from inbox if inbox value is present' do
      account.update(support_email: 'support@bchat.com')
      with_modified_env MAILER_SENDER_EMAIL: 'hello@bchat.com' do
        expect(account.support_email).to eq('support@bchat.com')
      end
    end
    ...
    it 'returns the support email from ENV if inbox value is nil' do
      ...
      with_modified_env MAILER_SENDER_EMAIL: 'hello@bchat.com' do
        expect(account.support_email).to eq('hello@bchat.com')
      end
    end
